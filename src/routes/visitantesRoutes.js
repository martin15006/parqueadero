...
const { registrarVisitantes, getVisitantes, registrarEntradaVisitante, registrarSalidaVisitante, buscarVisitantePorPlaca,registrarEntradaById } = require('../controllers/visitantesController');
